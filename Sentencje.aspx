<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sentencje.aspx.cs" Inherits="WebApplication1.Sentencje" %>
<!DOCTYPE html>
<html>
<head>
...
<body style="overflow: auto; top: 3px; left: -10px;">
...
<div class="header" style="text-shadow: 2px 2px 5px #a94242;">
  <h2 style="height: 77px">Sentencje</h2>
</div>
...
<script>
    ...
    function myFunction() {
        ...
        <asp:GridView ID="GridView5" runat="server" AutoGenerateColumns="False"  Font-Size="Large" BorderStyle="Solid" BorderWidth="3px" HorizontalAlign="Center" Width="100%" CssClass="grid">
            <Columns>
