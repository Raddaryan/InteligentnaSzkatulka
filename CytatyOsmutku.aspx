<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CytatyOsmutku.aspx.cs" Inherits="WebApplication1.CytatyOsmutku" %>

<!DOCTYPE html>
<html>
<head>
    <title>Cytaty o smutku</title>
...
<body style="overflow: auto; top: -1px; left: -11px;">
...
<div class="header" style="text-shadow: 2px 2px 5px #a94242;">
  <h2 style="height: 77px">Cytaty o smutku</h2>
</div>
...
<script>
    ...
    function myFunction() {
        ...
        <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False"  Font-Size="Large" BorderStyle="Solid" BorderWidth="3px" HorizontalAlign="Center" Width="100%" CssClass="grid">
            <Columns>
