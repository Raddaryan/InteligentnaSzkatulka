<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CytatyOmilosci.aspx.cs" Inherits="WebApplication1.CytatyOmilosci" %>

<!DOCTYPE html>
<html>
<head>
    <title>Cytaty o miłości</title>
...
<body style="overflow: auto; top: 5px; left: -10px; height: 680px;">
...
<div class="header" style="text-shadow: 2px 2px 5px #a94242;">
  <h2 style="height: 77px">Cytaty o miłości</h2>
</div>
...
<script>
    ...
    function myFunction() {
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  Font-Size="Large" BorderStyle="Solid" BorderWidth="3px" HorizontalAlign="Center" Width="100%" CssClass="grid">
            <Columns>
